  ...
  return (
    <main className="mt-3 mb-5 flex flex-col justify-center items-center m-auto p-3">
      <form className="w-full md:w-[40%]" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          <button type="submit" className="mt-1 w-100 flex justify-center gap-2 items-center border-2 p-2 rounded bg-inherit hover:bg-offwhite hover:text-black">
            Recuperar Senha
          </button>
          <Link to="/login" className="text-yellow-500 hover:text-opacity-50"><small>Login</small></Link>
        </div>
      </form>
    </main>
  )
