    ...
    <main className="mt-3 mb-5 flex flex-col justify-center items-center m-auto p-3">
      <form className="w-full sm:w-[60%] md:w-[50%] xl:w-[40%]" onSubmit={handleSubmit(enter)}>
        ...
        <div className="mt-4 sm:flex sm:gap-2">
          <button
            className="mt-1 w-full p-2 rounded bg-[hsl(180,100%,60%)] text-[hsl(0,0%,8%)] hover:bg-[hsl(180,100%,80%)] hover:border-2 hover:border-[hsl(180,100%,80%)] font-semibold transition-colors"
            type="submit"
          >
            Login
          </button>
